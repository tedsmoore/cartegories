#!/bin/bash
# Install the most-recent Cartegories dev build into the booted simulator.
# Glob lookup avoids hardcoding the DerivedData hash, which can change.
# Usage: ./install-dev-build.sh
set -euo pipefail

GLOB="$HOME/Library/Developer/Xcode/DerivedData/Cartegories-*/Build/Products/Debug-iphonesimulator/Cartegories.app"
